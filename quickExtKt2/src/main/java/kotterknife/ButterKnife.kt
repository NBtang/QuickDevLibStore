...
fun <V : View> IViewBindHolder.bindView(id: Int)
        : ReadOnlyProperty<IViewBindHolder, V> = required(id, viewFinder)
...
fun <V : View> IViewBindHolder.bindOptionalView(id: Int)
        : ReadOnlyProperty<IViewBindHolder, V?> = optional(id, viewFinder)
...
fun <V : View> IViewBindHolder.bindViews(vararg ids: Int)
        : ReadOnlyProperty<IViewBindHolder, List<V>> = required(ids, viewFinder)
...
fun <V : View> IViewBindHolder.bindOptionalViews(vararg ids: Int)
        : ReadOnlyProperty<IViewBindHolder, List<V>> = optional(ids, viewFinder)
...
private val IViewBindHolder.viewFinder: Finder<IViewBindHolder>
    get() = { requireContentView().findViewById(it) }
